            ...
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                    ...
                    <form class="flex items-center" action="/dashboard">
                        ...
                        <div class="relative w-full">
                            ...
                            <input type="text" id="simple-search"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                ...
                <div
                    ...
                    <a href="/dashboard/create" id="createProductModalButton" data-modal-target="createProductModal1"
                        ...
                        class="flex items-center justify-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none cursor-pointer dark:focus:ring-primary-800">
                                    ...
                                    <div id="deleteModal-{{ $post->id }}" tabindex="-1" aria-hidden="true"
                                        ...
                                        <div class="relative p-4 w-full max-w-md max-h-full">
                                            ...
                                            <div
                                                ...
                                                <p class="mb-4 text-gray-500 dark:text-gray-300">Apa anda yakin ingin
                                                    menghapus artikel <strong>{{ $post->title }}</strong>?</p>
